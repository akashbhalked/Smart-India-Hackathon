...
?>
  ...
  <div class="col card hoverable s10 pull-s1 m6 pull-m3 l4 pull-l4">
    <form method="post" action="Rfp_get_otp.php?mob=<?php $mob=$_GET['mob']; echo $mob; ?>">
      ...
      <div class="card-action right-align">
        ...
        <input type="submit" class="btn green waves-effect waves-light" value="Confirm" name="sub">
      </div>
    </form>
  </div>
</div>
