            ...
            <div class="col card hoverable s10 pull-s1 m6 pull-m3 l4 pull-l4" style="width:80%;">
                <form method="post" action="Bregister.php">
                    <div class="card-content center-align">
                        <span class="card-title"><b>Bhilai Steel Plant</b></span>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                ...
                                <div class="input-field inline">
                                    <input type="text" class="validate" name="mob" id="mob" data-length="10" />
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <label for="dob">DOB Format(DD/MM/YYYY)</label>
                            </div>
                        </div>
                        <!--
<div class="row">
...
-->
                    ...
                    <div class="right-align">
                        <a href="Blogin.php">Already a User?</a>
                    </div>
