...
?>
    ...
    <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#tab_1-1" data-toggle="tab">Approve</a></li>
              <li><a href="#tab_2-2" data-toggle="tab">Error</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1-1">
              <form method="post" action="statusupdate.php?rrnum=<?php echo $rrnum; ?>">
            <textarea class="form-control" rows="3" placeholder="Your Order has been Approved"></textarea>
