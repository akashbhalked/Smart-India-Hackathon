<!DOCTYPE html>
  ...
  <div class="col card hoverable s10 pull-s1 m6 pull-m3 l4 pull-l4">
    <form method="post" action="Bvalidate_login.php">
      <div class="card-content center-align">
        <span class="card-title">Bhilai Steel Plant Login Panel</span>
        <div class="row">
          <div class="input-field col s12">

            <label for="employee ID">Employee ID </label>
            <input type="text" class="validate" name="uname" id="uname" />
          </div>
          <div class="input-field col s12">
      ...
      <a href="Bforgetpass.php">Forget Password</a>
    </div>
